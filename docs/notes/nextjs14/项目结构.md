...
|  |  |
| --- | --- |
| [`app`](/nextjs14/route-fundamentals/) | App 路由器 |
| [`pages`](https://nextjs.org/docs/pages/building-your-application/routing) | Pages 路由器 |
| [`public`](/nextjs14/optimizing/static-assets/) | 要提供的静态资产 |
| [`src`](/nextjs14/configuring/src-directory/) | 可选的应用程序源文件夹 |
...
| [`package.json`](/nextjs14/install/#手动安装) | 项目依赖项和脚本 |
| [`instrumentation.ts`](/nextjs14/optimizing/instrumentation/) | OpenTelemetry 和检测文件 |
| [`middleware.ts`](/nextjs14/routing/middleware/) | Next.js 请求中间件 |
| [`.env`](/nextjs14/configuring/environment-variables/) | 环境变量 |
| [`.env.local`](/nextjs14/configuring/environment-variables/) | 本地环境变量 |
| [`.env.production`](/nextjs14/configuring/environment-variables/) | 生产环境变量 |
| [`.env.development`](/nextjs14/configuring/environment-variables/) | 开发环境变量 |
| [`.eslintrc.json`](/nextjs14/configuring/eslint/) | ESLint 的配置文件 |
...
以下文件约定用于在 [`app` 路由器](/nextjs14/route-fundamentals/)中定义路由和处理元数据。
...
|  |  |
| --- | --- |
| [`folder`](/nextjs14/route-fundamentals/#路由段) | 路由段 |
| [`folder/folder`](/nextjs14/route-fundamentals/#嵌套路由) | 嵌套路由段 |

#### **动态路由**

|  |  |
| --- | --- |
| [`[folder]`](/nextjs14/routing/dynamic-routes/) | 动态路由段 |
| [`[...folder]`](/nextjs14/routing/dynamic-routes/#捕获所有段) | 捕获所有路由段 |
| [`[[...folder]]`](/nextjs14/routing/dynamic-routes/#可选捕获所有段) | 可选的捕获所有路由段 |

#### **路由组和私有文件夹**

|  |  |
| --- | --- |
| [`(folder)`](/nextjs14/routing/route-groups/) | 不影响路由的路由组 |
| [`_folder`](/nextjs14/routing/route-groups/) | 将文件夹及其所有子段排除在路由之外 |

#### **并行和拦截路由**

|  |  |
| --- | --- |
| [`@folder`](/nextjs14/routing/parallel-routes/#插槽) | 命名槽 |
| [`(.)folder`](/nextjs14/routing/intercepting-routes/) | 拦截同级 |
| [`(..)folder`](/nextjs14/routing/intercepting-routes/) | 拦截上一级 |
| [`(..)(..)folder`](/nextjs14/routing/intercepting-routes/) | 拦截两级上 |
| [`(...)folder`](/nextjs14/routing/intercepting-routes/) | 从根拦截 |
